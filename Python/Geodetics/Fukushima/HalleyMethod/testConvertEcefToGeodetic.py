...
from convertEcefToGeodetic             import convertEcefToGeodetic;
from convertGeodeticToEcef             import convertGeodeticToEcef;
#-------------------------------------------------------------------------------
...
#-------------------------------------------------------------------------------
earthEllipsoidalFlatteningFactor    = 1.0E0 /                                  \
...
#-------------------------------------------------------------------------------
#
#  Fixed the geocentric East longitude at 45 degrees for test purposes.
#
#-------------------------------------------------------------------------------
...
for latitudeIndex in range(                                                    \
     ...
     #--------------------------------------------------------------------------
        for altitudeIndex in range(                                            \
          ...
          #---------------------------------------------------------------------
             xEcefMeters = ecefMetersVector[ 0 ];
             yEcefMeters = ecefMetersVector[ 1 ];
             zEcefMeters = ecefMetersVector[ 2 ];
          #---------------------------------------------------------------------
          ...
          #- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
             totalElapsedTimeMicroSeconds    = totalElapsedTimeMicroSeconds +  \
...
print                                                                          \
 (
   "%+10.2f" % ( totalElapsedTimeMicroSeconds ),
   end = ""
 );
print                                                                          \
 (
